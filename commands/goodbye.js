       ...
       async function etep1_(msg, etep1){
          message.channel.awaitMessages(response => message.content, {
              ...
              .then((collected) => {
                  const text = collected.first().content;
                   serverData[message.guild.id].goodbye1 = text;
                   fs.writeFile('./storage/serverData.json', JSON.stringify(serverData, null, 2), (err) => {
                    if (err) 
                    {
                      ...
                      msg.edit(etep1 = new Discord.RichEmbed()
                        ...
                        .setDescription(lg[language].welcome_etep1_1 + `${serverData[message.guild.id].goodbye1}` + lg[language].welcome_etep1_2)
        ...
        async function etep2(msg, etep1){
          message.channel.awaitMessages(response => message.content, {
              ...
              .then((collected) => {
                  const text = collected.first().content;
                   serverData[message.guild.id].goodbye2 = text;
                   fs.writeFile('./storage/serverData.json', JSON.stringify(serverData, null, 2), (err) => {
                    if (err) 
                    {
                      const YDHP = new Discord.RichEmbed()
                      ...
                      msg.edit(etep1 = new Discord.RichEmbed()
                        .setColor(DC)
                        .setImage('https://www.mediafire.com/convkey/8162/h5fs3inu6w6opmmzg.jpg')
                        .setDescription(lg[language].welcome_etep1_1 + `${serverData[message.guild.id].goodbye2}` + lg[language].welcome_etep2_2)
          ...
          message.channel.awaitMessages(response => message.content, {
              ...
              .then((collected) => {
                  ...
                  if(joinChannel == null || !joinChannel){
                   ...
                   serverData[message.guild.id].goodbye = text;
                   fs.writeFile('./storage/serverData.json', JSON.stringify(serverData, null, 2), (err) => {
                    if (err) 
                    {
                      const YDHP = new Discord.RichEmbed()
                      ...
                      msg.edit(etep1 = new Discord.RichEmbed()
                        .setColor(DC)
                        .setImage('https://www.mediafire.com/convkey/8162/h5fs3inu6w6opmmzg.jpg')
                        .setDescription(lg[language].welcome_etep3_1 + `${serverData[message.guild.id].goodbye}` + lg[language].goodbye_etep3_2)
